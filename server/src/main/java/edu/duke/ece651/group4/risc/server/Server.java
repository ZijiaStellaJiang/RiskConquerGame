...
public class Server {
   ...
   * Server Constructor
   * 
   * @param port port number to receive connection
   */
  ...
  /**
   * Receive 2 connections from client
   */
   ...
   * Sends map to client
   * 
   * @param player_id which player to send
   */
  ...
  /**
   * initialize the game including accept connection and send map
   */
  ...
  /*
   * public void run() { // initialize game: receive connection and send the map
   * initializeGame();
   * 
