...
public class UnitNumberRuleCheckerTest {
    ...
    public void test_unitNumber_checker(){
        ...
        Territory<Character> t1 = new Territory<>("t1",numberChecker1);
        Territory<Character> t2 = new Territory<>("t2",numberChecker1);
        ...
        assertEquals(null,numberChecker1.checkPlacement(parser1,map));
        ...
        ,numberChecker1.checkPlacement(parser2,map));
    }
}
