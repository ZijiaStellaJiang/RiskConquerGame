...
//        title.setFontSmoothingType(FontSmoothingType.LCD);
        exit_btn.addEventHandler(MouseEvent.MOUSE_ENTERED, e->exit_btn.setCursor(Cursor.HAND));
        ...
        start_btn.addEventHandler(MouseEvent.MOUSE_ENTERED, e->start_btn.setCursor(Cursor.HAND));
